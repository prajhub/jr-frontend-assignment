...
export default function TopAlbums() {
     ...
     const {data: topAlbums} = useQuery<TopAlbum[]>({
        queryKey: ['topAlbums'],
    ...
    return (
        ...
        <span className="font-semibold text-lg">Trending albums this week</span>
            ...
            {topAlbums?.map((album: TopAlbum) => (
                    <Link href='/' className="h-96 flex flex-col p-5 rounded border group hover:scale-105 transition-transform ease-out duration-200">
